...
{
	static auto SetLocalPlayerReadyFn = reinterpret_cast<bool( __stdcall* )( const char* )>( Utilities->Memory_PatternScan( "client_panorama.dll", "55 8B EC 83 E4 F8 8B 4D 08 BA ? ? ? ? E8 ? ? ? ? 85 C0 75 12" ) );
