...
//
//				auto glove = (C_BaseAttributableItem*)Interfaces::EntityList->GetClientEntityFromHandle2(wearables[0]);
//
//				if (!glove)
//				{
//					const auto our_glove = (C_BaseAttributableItem*)Interfaces::EntityList->GetClientEntityFromHandle2(glove_handle);
//
//					if (our_glove)
//					{
