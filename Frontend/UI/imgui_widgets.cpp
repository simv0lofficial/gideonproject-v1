...
void ui::TabButton(const char* label, int* selected, int num, int total) {
    ...
    ImVec2 pos = window->Pos + ImVec2(6, 9) + ImVec2((window->Size.x - 12) / total * num, 0) - ImVec2(0, 1);
    ...
    if (*selected != num) {
        window->DrawList->AddRectFilled(pos, pos + size, ImColor(12 / 255.f, 12 / 255.f, 12 / 255.f, g.Style.Alpha));
        window->DrawList->AddLine(pos + ImVec2(-1, size.y), pos + size, ImColor(45 / 255.f, 45 / 255.f, 45 / 255.f, g.Style.Alpha));
    }
    else {
        if (num != 0)
            window->DrawList->AddLine(pos, pos + ImVec2(0, size.y + 1), ImColor(45 / 255.f, 45 / 255.f, 45 / 255.f, g.Style.Alpha));
        if (num != total - 1)
            window->DrawList->AddLine(pos + ImVec2(size.x - 1, 0), pos + ImVec2(size.x - 1, size.y + 1), ImColor(45 / 255.f, 45 / 255.f, 45 / 255.f, g.Style.Alpha));
    }
