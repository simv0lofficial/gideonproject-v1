        ...
        else
        {
            ...
            if (!(flags & ImGuiWindowFlags_NoBackground))
            {
                if (!(flags & ImGuiWindowFlags_ChildWindow) && !(flags & ImGuiWindowFlags_Popup) && !(flags & ImGuiWindowFlags_Tooltip)) {
                    ...
                    window->DrawList->AddRectFilled(window->Pos + ImVec2(6, 6), window->Pos + ImVec2(window->Size.x - 6, 8), c_menu::get()->get_accent_color());
					window->DrawList->AddRectFilled(window->Pos + ImVec2(6, 7), window->Pos + ImVec2(window->Size.x - 6, 8), ImColor(0.f, 0.f, 0.f, ImClamp(150 / 255.f, 0.f, g.Style.Alpha)));
				}
                else {
